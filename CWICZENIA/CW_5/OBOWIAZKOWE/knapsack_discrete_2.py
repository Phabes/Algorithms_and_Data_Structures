# FUNKCJA: f(i,j) -> minimalna waga dla przedmiotów od 0 do i, które mają zysk j lub większy jeśli jest to możliwe do uzyskania, jeśli nie to jest to suma wag wszystkich przedmiotów + 1
